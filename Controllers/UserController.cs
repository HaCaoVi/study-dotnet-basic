...
public class UserController : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<PagedResult<UserDto>>>> GetUsers(
        [FromQuery] QueryUserDto queryUserDto, CancellationToken ct)
    {
    ...
    public async Task<ActionResult<ApiResponse<UserDto>>> CreateUser(
        [FromBody] CreateUserDto createUserDto, CancellationToken ct)
    {
    ...
    public async Task<ActionResult<ApiResponse<object>>> UpdateUser(
        Guid id, [FromBody] UpdateUserDto updateUserDto, CancellationToken ct)
    {
